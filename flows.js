...
exports.deployContract = async (ask) => {
  const abiPath = await ask(
    'Please type the path to the abi json file, i.e. (../src/kitty-core/Offers.json):',
  );
  ...
  const params = [
    '0x5328276603d169165d0f71ca67ccc89c45027df3',
    '0xb8a3FD5785D700E485EC68A13EEC1E9670889cB5',
    '86400',
    '104500000000000000',
    '1000',
    '4000000000000000',
  ...
  //   'Please type the parameters to the contract constructor, separates multiple parameters with comma (","), i.e. ():',
  // )).split(',');
  let value = '0';
